    ...
    >
      ...
      <Panel header="Generate text">
        <Text>
          ...
          Description Generator. Using the product information from your
          catalog, the generator creates product descriptions in limitless
          styles and voices designed to drive traffic to your storefront and
          generate sales.
        </Text>
        <Image
